function DEGENMOD:RegisterWardrobeModSupport(_DEGENMOD)
	if WardrobePlus ~= nil then
		OWRP.AddNewCostume("DMCondom", "Filled Condom", "gfx/characters/costume_002w_protection.anm2",false,false)
		...
		OWRP.AddNewCostume("DMJenHat", "Robo Hair", "gfx/characters/costume_009w_jenny_hair.anm2",false,false)
		OWRP.AddNewCostume("DMJenSet", "Robo Set", "gfx/characters/costume_010w_jenny_set.anm2",false,false)
	end
end
